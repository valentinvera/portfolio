    ...
    <section className="pb-30">
      <div className="flex flex-col gap-2 ml:gap-6 sm:gap-4">
        ...
        <div className="flex gap-6">
          ...
          <a
            href="#contact"
            className="group inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full bg-primary ml:px-8 px-6 ml:py-4 py-4 font-medium ml:text-base text-primary-foreground text-sm transition-colors hover:bg-primary/90 disabled:pointer-events-none disabled:opacity-50"
          >
            {t("main.hero.calls_to_actions.get_in_touch")}
            <Icons.arrowRight
              size={16}
              className="size-4 transition-all duration-200 group-hover:translate-x-1"
            />
          </a>
        </div>
      </div>
